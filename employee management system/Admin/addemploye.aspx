...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row m-0 bg-white rounded m-3">
            ...
            <div class="row">
                ...
                <div class="col col-6 col-md-6">
                    <div class="form-group">
                        ...
                        <asp:TextBox runat="server" ID="TextBox1" CssClass="form-control border-primary border-1" />
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col col-6 col-md-6">
                    <div class="form-group">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Connectionstr %>" SelectCommand="SELECT [DepartmentName] FROM [DepartmentTable]"></asp:SqlDataSource>
                    </div>
                </div>
            ...
            <div class="row mb-5">
                <div class="col col-6 col-md-6">
                    <div class="form-group pmd-textfield pmd-pmd-textfield-floating-label">
                        <asp:Button runat="server" ID="submit" Text="Submit" CssClass="btn btn-primary mt-3" />
                    </div>
                </div>
            </div>
